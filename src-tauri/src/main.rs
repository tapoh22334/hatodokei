...
use tauri::{SystemTray, SystemTrayEvent, Manager, CustomMenuItem, SystemTrayMenu};
...
use crate::scheduler::{Scheduler, SMessage};
...
#[tauri::command]
fn set_table_row(row: ttelement::TTElement, tx: tauri::State<std::sync::mpsc::SyncSender<SMessage>>) {
...
fn main() {
  ...
  tauri::Builder::default()
      ...
      .invoke_handler(tauri::generate_handler![greet, get_settings, set_master_volume, set_master_mute, play, set_table_row])
      .run(context)
